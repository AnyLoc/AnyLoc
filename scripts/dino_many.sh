...
datasets=("eiffel") #("hawkins_long_corridor" "VPAir" "laurel_caverns" "GNSS_Tartan")
exp_prefix="dino"
# Dino parameters
...
desc_facets=("key")
# VLAD parameters
num_clusters=(128) #16 8)
vlad_mode="hard"
vlad_sm_temp="1.0"
# ----------------- Weights and Biases parameters -----------------
wandb_entity="vpr-vl"
wandb_project="Unstructured"      # Project name (set to "None" for no WandB)
wandb_group="VPAir"      # Group (for runs)
...
for ds in ${datasets[*]}; do
    ...
    wandb_group="${ds}"    
    wandb_name="DINO_VLAD/${ds}/${desc_layer}"
    # Construct the python command
    python_cmd="python ./dino_vlad_plot_qual.py"
