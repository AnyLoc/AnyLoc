...
class Hawkins(CustomDataset):
    ...
    """
    def __init__(self,args,datasets_folder='/home/jay/Downloads/vl_vpr_datasets',dataset_name="hawkins_long_corridor",split="train",use_ang_positives=False,dist_thresh = 8,ang_thresh=20,use_mixVPR=False,use_SAM=False):
        super().__init__()
...
if __name__=="__main__":
    args = 0
    vpr_ds = Hawkins(args,"/ocean/projects/cis220039p/shared/datasets/vpr/datasets_vg","hawkins",'test')
